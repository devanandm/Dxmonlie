...
എന്റെ ന്യൂ ഫീച്ചേർസ് ചാനലിൽ @DXMBOTS ഇടുന്നതായിരിക്കും. സംശയങ്ങൾക്ക് @DXMBOTZ എന്ന ഗ്രൂപ്പിൽ വരാവുന്നതാണ്.....

എന്നെ നോക്കി നടത്തുന്നത്  [ഇദ്ദേഹം](tg://user?id={}) ആണ് . എന്നെ നിർമിച്ചിരിക്കുന്നത് python3യിൽ 
python-telegram-bot library ഉപയോഗിച്ചാണ്.... ഞാൻ പൂർണമായും opensource ആണ്.. എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](https://heroku.com/deploy?template=https://github.com/devanandm/Dxmonlie) കാണാവുന്നതാണ്...
എന്നെ ഉപയോഗിക്കാൻ ആവിശ്യമായ commandകൾ അറിയാൻ /help കൊടുത്താൽ മതിയാകും..
വിവരങ്ങൾക്കായി /info  ഉപയോഗിക്കാവുന്നതാണ്...
[Devalaper](http://telegram.dog/devalaper)
[YOUTUBE](https://youtube.com/channel/UCrQQJGsaHEnUtFfcLB95iGQ)
[Update channel](http://telegram.dog/DXMBOTS]
[Support group](http://telegram.dog/DXMBOTZ]
[Github](https://github.com/devanandm/]
[Gmail](www.keralablog123@gmail.com)
[Support](http://telegram.dog/devalaper)
നോക്കി നടത്തുന്നത് [ഇദ്ദേഹം](tg://user?id={})
[Google](www.google.com)
[Python](www.python.com)
[HEROKU](www.heroku.com)
[Facebook](www.facebooke.com)
[Instagram](www.instagram.com)

"""

HELP_STRINGS = """
 എന്നെ ഉണ്ടാക്കാൻ സഹായിച്ചത്

Jalal.n only id:1125370012
Mvp:@DXM_devalaper

Update channel:@DXMBOTS
Update group: @DXMBOTZ 
...
It took lots of work for [my creator](t.me/devalaper) to get me to where I am now, and every donation helps \
